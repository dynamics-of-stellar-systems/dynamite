...
#TIM END
    ...
    def create_orbital_component_files_giu(self,
        ...
        wdir = self.model_directory + diri_o + '/' #bestfit folder
        ...
        mgepar, distance, th_view, ph_view, psi_view, ml, bhmass,softlen, \
            ...
            = self.plotter.triaxreadparameters(w_dir=wdir)
    ...
    def plot_comps_giu(self,
        ...
        #TIM wdir = w_dir + gal + '/figure_nn/'
        #TIM wwdir=w_dir +  gal+'/'
        wdir = self.output_directory + 'figure_nn/'
        wwdir = self.output_directory
    ...
    def run_dec(self, gal, Re):
        ...
        self.logger.info(f'Best model in {diri_o}, {ml_str}')

        rootname=''
        wdir = self.model_directory + diri_o + '/'
        bf_dir=wdir+ml_str
        ...
        scale_factor = self.scale_factor_find(bf_dir) #read the scale factor used to rescale the orbits
        ...
        losvd_histograms, intrinsic_masses, n_orbs, projected_masses = \
            self.read_losvd_histograms(wdir, n_apertures, scale_factor)  #read the losvd of the orbits

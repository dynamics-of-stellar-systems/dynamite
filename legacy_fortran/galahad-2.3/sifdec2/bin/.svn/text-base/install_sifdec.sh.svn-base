...
CPP='cpp -P'
EXT=$$
sed -f ${SIFDEC}/build/scripts/protect.sed ${SIFDEC}/build/scripts/makefile.cmds | ${CPP} -I${SIFDEC}/config -I. -DFromInstallSifDec ${UMAKE_OPTIONS[@]} | sed -f ${SIFDEC}/build/scripts/gettabs.sed > /tmp/Makefile.cmds.${EXT}
cd /tmp
#[[  -f "cmds"  ]] && rm -f cmds
...
$CAT /tmp/cmds.${EXT}                              >> $MYSIFDEC/install_mysifdec
$CP -f /tmp/cmds.${EXT} $MYSIFDEC/cmds.basic

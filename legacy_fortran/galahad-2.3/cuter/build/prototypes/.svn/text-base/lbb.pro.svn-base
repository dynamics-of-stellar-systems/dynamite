...
#
# lbb: apply L-BFGS-B to a problem and delete the executable after use.
#
#{version}
#
...
#  and/or libraries (files of the form lib*.a) for the L-BFGS-B package.

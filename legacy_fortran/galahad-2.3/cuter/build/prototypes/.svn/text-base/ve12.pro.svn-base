...
#
# ve12: apply HSL_VE12 to a problem and delete the executable after use.
#
#{version}
#
...
#  and/or libraries (files of the form lib*.a) for the HSL_VE12 package.
...
set PACKOBJ=(cuterinter.o readin.o libve12.a)
...
if ( -e $MYCUTERPRECBIN/${PAC}ma.o ) then
  if ( -e $CUTER/common/src/tools/${PAC}ma.f90 && -e $PACKFULL ) then
    set newer = (`ls -cL $PACKFULL $MYCUTERPRECBIN/${PAC}ma.o`)

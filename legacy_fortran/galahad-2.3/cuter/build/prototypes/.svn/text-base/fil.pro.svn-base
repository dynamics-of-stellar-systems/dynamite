...
#
# fil: apply FILTER to a problem and delete the executable after use.
#
#{version}
#
...
setenv SYSLIBS "-lfilter"

#
#  define the name(s) of the object file(s) (files of the form *.o) 
#  and/or libraries (files of the form lib*.a) for the FILTER package.

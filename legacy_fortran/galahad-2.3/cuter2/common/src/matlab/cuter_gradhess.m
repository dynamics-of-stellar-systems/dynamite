function [varargout] = cuter_gradhess( varargin )
...
% Usage:  [g,H] = cuter_gradhess( x )   if the problem is unconstrained, or
%       [g,J,H] = cuter_gradhess( x, v, gradf, jtrans )  if it is constrained
...
%                 jtrans = false: returns the Jacobian in J
    ...
    [varargout{:}] = mcuter('gradhess',varargin{:});

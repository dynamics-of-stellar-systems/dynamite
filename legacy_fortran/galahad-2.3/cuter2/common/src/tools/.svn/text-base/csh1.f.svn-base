...
C
C  Compute the Hessian matrix of the constraint part of the Lagrangian 
C  function of a problem initially written in Standard Input Format (SIF).
C
...
C
C  Version which ignores objective function for FilterSQP
C

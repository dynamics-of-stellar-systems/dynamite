...
C
C  Compute the values of the objective function and general constraints
C  of a function initially written in Standard Input Format (SIF).
C
...
CS    REAL               FTT   , ONE   , ZERO
CD    DOUBLE PRECISION   FTT   , ONE   , ZERO
...
C
     ...
     *                .FALSE., IGSTAT )
      END IF
C
C  Compute the objective and constraint function values.
C

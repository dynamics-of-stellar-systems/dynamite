...
C  of the constraint part of the Lagrangian function for the problem and
C    a given vector P. The result is placed in RESULT. If GOTH is .TRUE. 
C  the second derivatives are assumed to have already been computed. If

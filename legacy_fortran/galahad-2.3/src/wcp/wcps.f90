...
! integer components complete   
   CALL WCP_initialize( data, control )       ! Initialize control parameters
...
! real components complete   
   CALL WCP_solve( p, data, control, info )   ! Solve problem
   ...
   END IF
   CALL WCP_terminate( data, control, info )  !  delete internal workspace

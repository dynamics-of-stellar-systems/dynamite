...
!  Scalars
      ...
      INTEGER :: n, m, A_ne, H_ne, ir, ic, ifail, liw, iores
!     INTEGER :: npm, np1
      INTEGER :: status, mfixed, mdegen, iter, nfacts, nfixed, ndegen, mequal
      INTEGER :: alloc_stat, newton, nmods
...
!  Arrays
      ...
      TYPE ( QTRANS_trans_type ) :: QQTRANS_trans
...
!  Get the scale factors
          ...
          CALL QTRANS_get_factors( QQTRANS_trans, QTRANS_data, QTRANS_control,  &
...
!  Apply the scalings to the problem
          ...
          CALL QTRANS_apply( QQTRANS_trans, QTRANS_data, QTRANS_control,        &
...
!  If the problem was scaled, unscale it.
        ...
        IF ( scale > 0 ) THEN
          IF ( scale <= 5 ) THEN
            ...
            DEALLOCATE( SH, SA )
          ELSE
            CALL QTRANS_apply_inverse( QQTRANS_trans, QTRANS_data,              &

...
!     ---------------------------------------------------
!    |                                                   |
!    | Acob, an adaptive cubic-regularisation algorithm |
...
!NOT95USE GALAHAD_CPU_time
     ...
     PUBLIC :: ACOB_initialize, ACOB_read_specfile, ACOB_solve,              &
               ACOB_terminate, NLPT_problem_type, ACOB_projection
...
!   Provide default values for ACOB controls
...
!-----------------------------------------------
     ...
     CHARACTER( LEN = 16 ), PARAMETER :: specname = 'ACOB          '
...
!  ACOB_solve, a method for finding a local minimizer of a function subject 
...
!  End of subroutine ACOB_terminate
     ...
     SUBROUTINE ACOB_projection( n, C, X_l, X_u, X, A, b )

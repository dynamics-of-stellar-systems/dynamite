...
!-*-*-*-*-*- R A N D _ R A N D O M _ R E A L  S U B R O U T I N E  *-*-*-*-*-

         SUBROUTINE RAND_random_real ( seed, positive, random ) 
...
!  Multiply by 1/(2**31-1)
         ...
         END SUBROUTINE RAND_random_real

!-*-*-*-*  R A N D _ R A N D O M _ I N T E G E R   S U B R O U T I N E  *-*-

         SUBROUTINE RAND_random_integer ( seed, n, random ) 
...
!  If n is less than or equal to 1, set random to n.
         ...
         END SUBROUTINE RAND_random_integer 

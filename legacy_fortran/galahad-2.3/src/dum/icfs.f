...
!-----------------------------------------------
      ...
      INTEGER, INTENT( OUT ) :: LCOL_PTR( N + 1 )
      INTEGER, INTENT( OUT ) :: LROW_IND( NNZ + N * P )
      INTEGER, INTENT( OUT ) :: IWA( 3 * N )
      DOUBLE PRECISION, INTENT( INOUT ) :: ALPHA
      DOUBLE PRECISION, INTENT( OUT ) :: WA1( N ), WA2( N )
      DOUBLE PRECISION, INTENT( IN ) :: A( NNZ ), ADIAG( N )
      DOUBLE PRECISION, INTENT( OUT ) :: L( NNZ + N * P )
      DOUBLE PRECISION, INTENT( OUT ) :: LDIAG( N )

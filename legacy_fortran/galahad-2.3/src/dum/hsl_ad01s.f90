...
MODULE HSL_AD01_FORWARD_SINGLE
...
!  Dummy HSL_AD01_FORWARD_SINGLE module
...
!  Non-executable statements
 ...
 2000    FORMAT( /, ' We regret that the solution options that you have ', /, &
                    ...
                    ' module HSL_AD01_FORWARD_SINGLE with its H...', /,       &
...
END MODULE HSL_AD01_FORWARD_SINGLE
...
MODULE HSL_AD01_BACKWARD_SINGLE
...
!  Dummy HSL_AD01_BACKWARD_SINGLE module
...
!  Non-executable statements
 ...
 2000    FORMAT( /, ' We regret that the solution options that you have ', /, &
                    ...
                    ' Library), this ', /,                                    &
                    ' option may be enabled by replacing the dummy ', /,      &
                    ' module HSL_AD01_BACKWARD_SINGLE with its HSL ',/,       &
                    ' namesake and dependencies. See', /,                     &
                    '   $GALAHAD/src/makedefs/packages for details.', //,     &
                    ' *** EXECUTION TERMINATING *** ', / )
...
END MODULE HSL_AD01_BACKWARD_SINGLE

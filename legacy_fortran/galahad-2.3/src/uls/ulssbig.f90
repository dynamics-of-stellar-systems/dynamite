! THIS VERSION: GALAHAD 2.1 - 22/03/2007 AT 09:00 GMT.
   PROGRAM GALAHAD_ULS_big_example
...
!  READ( 5, * ) ( MATRIX%ROW( i ), MATRIX%COL( i ), MATRIX%VAL( i ), i = 1, ne )
   READ( 5, * ) ( MATRIX%COL( i ), MATRIX%ROW( i ), MATRIX%VAL( i ), i = 1, ne )
...
!  Write row and column reorderings
   ...
   CALL ULS_special_rows_and_cols( FACTORS, rank, COLS, ROWS, info )
...
!  WRITE( 28, "( A, /, ( 10I5 ) )" ) ' column orderings:', COLS( : rank )
   WRITE(28,"( (  ' row/col ', 2I6 ) )" ) (  ROWS( i ), COLS( i ), i = 1, rank )
   STOP
...
!  Clean up
   ...
   END PROGRAM GALAHAD_ULS_big_example

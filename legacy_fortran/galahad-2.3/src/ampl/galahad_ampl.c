 ...
 *
 * This is version v0.3 (20/Oct/2006)
 *
...
#define CHR (char*)
     ...
     * RUNQPA.SPC,  RUNQPB.SPC,  RUNQPC.SPC,
     * RUNLANB.SPC, RUNPRE.SPC   and RUNFILT.SPC.
     *
...
#define __FUNCT__ "csh"
    ...
    void CSH( integer * n, integer * m, GalahadReal * x, integer * lv,
        ...
        *nnzh = ( integer ) sphsetup( -1, 1, 1, 1 );
         ...
         * QPA, QPB, QPC, PRE and LANB do not use H_col.
         */

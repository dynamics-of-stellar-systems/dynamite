...
!-*-*-*-*-*-*-*-*-  G A L A H A D   R U N Q P C _ D A T A  *-*-*-*-*-*-*-*-*-*-
...
!    | to QPC, an interior-point/working-set crossover  |
...
!  Scalars
      ...
      INTEGER :: n, m, ir, ic, ifail, liw, iores
!     INTEGER :: np1, npm
      INTEGER :: i, j, l, factorization_integer, factorization_real
...
!  Arrays
      ...
      TYPE ( QTRANS_trans_type ) :: QTRANS_tt
...
!  Store the problem dimensions
      ...
      CALL SMT_put( prob%H%type, 'SPARSE_BY_ROWS' )
...
!  Get the scale factors
          ...
          CALL QTRANS_get_factors( QTRANS_tt, QTRANS_data, QTRANS_control,     &
...
!  Apply the scalings to the problem
          ...
          CALL QTRANS_apply( QTRANS_tt, QTRANS_data, QTRANS_control,           &

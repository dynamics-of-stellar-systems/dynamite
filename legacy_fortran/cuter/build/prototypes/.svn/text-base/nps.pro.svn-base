...
#
# nps: apply NPSOL to a problem and delete the executable after use.
#
#{version}
#
# Use: nps [-n] [-h] [-s] [-k] [-r] [-o i] [-l secs] [-debug]
#
...
#  and/or libraries (files of the form lib*.a) for the NPS package.
...
if (-e fort.9) $MV fort.9 NPSOL.LIS

...
#
# stn: apply STENMIN to a problem and delete the executable after use.
#
#{version}
#
# Use: stn [-n] [-h] [-s] [-k] [-r] [-o i] [-l secs] [-debug]
#

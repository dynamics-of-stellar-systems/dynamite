...
C --- INITIAL PREPARATIONS   
      ...
      HLAMB=0.D0
      IASTI=0
C --- HMIN defined by Remco 25 feb 06
      HMIN=(XEND-X)/(NMAX*0.75)
...
C --- WE REQUIRE  FAC1 <= HNEW/H <= FAC2
      ...
      HNEW=H/FAC
C --- RvdB 26feb06 Accept step if step size is Hmin
      IF(ERR.LE.1.D0)THEN
C --- STEP IS ACCEPTED  
...
C ----- COMPUTE PLACE OF II-TH COMPONENT 
   ...
   5  CONTINUE
      ...
      THETA=(X-XOLD)/H
      THETA1=1.D0-THETA
      CONTD8=CON(I)+THETA*(CON(ND+I)+THETA1*(CON(2*ND+I)+THETA*

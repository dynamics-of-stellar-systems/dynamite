...
Quenneville et al. 2022 <https://iopscience.iop.org/article/10.3847/1538-4357/ac3e68>`_ reported a bug in the orbit calculation of the original van den Bosch 2008 <https://academic.oup.com/mnras/article/385/2/647/1068433>`_ code that is used in DYNAMITE. We corrected the old mirroring in DYNAMITE, starting from version 3.0.0. From this version on, the default DYNAMITE run uses the correct mirrroring. We caution the user to not use the old orbit calculation routine.

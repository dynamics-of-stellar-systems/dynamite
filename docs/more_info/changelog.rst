...
- Bugfix: Gauss Hermite kinematic maps now consider the kinematics' systematic errors `GH_sys_err`
- Bugfix: Gauss Hermite kinematics' systematic errors `GH_sys_err` are now also applied when calculating `kinmapchi2`. This may affect parameter generation.
